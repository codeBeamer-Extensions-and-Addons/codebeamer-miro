// Types from here: https://raw.githubusercontent.com/miroapp/app-examples/master/miro.d.ts
// Version as of: 20-11-29 SDK v1.1
...
declare module SDK {
	...
	interface IBoardWidgetsCommands {
		...
		create<T extends IWidget>(
			widgets: OneOrMany<{ type: string; [index: string]: any }>
		): Promise<T[]>;
