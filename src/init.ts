...
miro.onReady(async () => {
	...
	console.info(
		`[codeBeamer-sync] Plugin v0.9.10 initialized. Experiencing issues? Let us know at https://github.com/codeBeamer-Extensions-and-Addons/codebeamer-miro/issues`
	);
});
