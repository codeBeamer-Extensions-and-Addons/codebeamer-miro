...
miro.onReady(async () => {
	...
	console.info(
		`[codeBeamer-sync] Plugin v.0.7.1 initialized. Experiencing issues? Let us know at https://github.com/codeBeamer-Extensions-and-Addons/codebeamer-miro/issues`
	);
});
