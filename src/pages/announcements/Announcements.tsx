...
export default function Announcements() {
	return (
		<Swiper>
			<SwiperSlide>
				<div className="container">
					<h2 className="h2">
						...
						<span>codebeamer-cards Version 3 is here!</span>
					</h2>
					<div>
						<p>
							Version 3 is marked by an update to Miro's
							Development Kit (SDK) and major structural changes
							behind the scenes. The new SDK will hopefully
							provide us new opportunities to make the app better,
							but it currently also comes with some drawbacks.
						</p>

						<h4 className="h4">Top level Changes:</h4>
						<ul>
							<li>
								Improved the user experience by making the app
								more simple and adding hints / feedback.
							</li>
							<li>
								Rewrote the App with Miro's new SDK and a
								modular and concise framework, that should
								accelerate future development.
							</li>
							<li>
								Removed some functionality not currently
								supported by the updated SDK
							</li>
						</ul>
					</div>
				</div>
			...
			<SwiperSlide>
				<div className="container">
					<h3 className="h3">Look at our new logo!</h3>
					<div>
						<svg
							className="pos-adjusted-up wh-40p"
							enableBackground="new 0 0 256 256"
