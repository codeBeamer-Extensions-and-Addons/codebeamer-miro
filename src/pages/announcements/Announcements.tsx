...
export default function Announcements() {
	...
	return (
		...
		>
			...
			<div className="mb-5">
				<h2 className="h2 text-center">
					...
					<span className="roche-primary">
						codebeamer-cards Version 1.2 Release
					</span>
				</h2>
				<p className="text-center">
					<b>
						Welcome to Version 1.2 of{' '}
						<span className="roche-primary">codebeamer-cards</span>{' '}
						!
					</b>
					<p className="mt-5">
						This release adds some minor improvements and fixes to
						the Item Details introduced in v1.1.0. See the{' '}
						<a
			...
			<div className="mb-5">
				<h2 className="h2 text-center">
					<span className="muted">2022-11-23</span>
					<br />
					<svg
						className="pos-adjusted-up wh-40p"
						enableBackground="new 0 0 256 256"
