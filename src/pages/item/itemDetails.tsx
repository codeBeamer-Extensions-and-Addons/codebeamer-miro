...
export default function ItemDetails(props: { itemId: string; cardId: string }) {
  ...
  const [triggerFieldOptionsQuery, fieldOptionsQueryResult] =
    useLazyGetFieldOptionsQuery();
  const [triggerUpdateItem, updateItemResult] = useLazyUpdateItemLegacyQuery();
  ...
  const getFieldLabel = (fieldName: string): string => {
    ...
    let label = trackerSchemaQueryResult.data.find(
      (r) => r.legacyRestName == fieldName || r.trackerItemField == fieldName
    )?.name;
  ...
  const formik = useFormik({
    initialValues: {
      assignedTo: item?.assignedTo
        ...
        : [],
      teams: item?.teams ? (item.teams as CodeBeamerReferenceMinimal[]) : [],
            ...
            >
              ...
              >
                ...
                <Select
                  ...
                  options={
                    selectOptions.find((s) => s.key == ASSIGNEE_FIELD_NAME)
                      ?.values || []
                  }
                  ...
                  onChange={(values) =>
                    formik.setFieldValue(ASSIGNEE_FIELD_NAME, values)
                  }
                  maxMenuHeight={180}
                />
              </div>
              ...
              >
                ...
                <Select
                  ...
                  classNamePrefix="select"
                  options={
                    selectOptions.find((s) => s.key == TEAM_FIELD_NAME)
                      ?.values || []
                  }
              ...
              >
                ...
                <Select
                  ...
                  classNamePrefix="select"
                  options={
                    selectOptions.find((s) => s.key == VERSION_FIELD_NAME)
                      ?.values || []
                  }
              ...
              >
                ...
                <Select
                  ...
                  classNamePrefix="select"
                  options={
                    selectOptions.find((s) => s.key == SUBJECT_FIELD_NAME)
                      ?.values || []
                  }
              ...
              >
                <label>{getFieldLabel(STORY_POINTS_FIELD_NAME)}</label>
                <input
                  type="number"
                  className="input"
                ...
                {!animateSuccess && (
                  <button
                    ...
                    className={`fade-in button button-primary ${
                      updateItemResult.isFetching ? "button-loading" : ""
                    }`}
