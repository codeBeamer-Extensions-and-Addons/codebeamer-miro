...
async function init() {
	...
	console.info(
		`[codeBeamer-cards] Plugin v1.5.1 initialized. Experiencing issues? Let us know at https://github.com/codeBeamer-Extensions-and-Addons/codebeamer-miro/issues`
	);
}
